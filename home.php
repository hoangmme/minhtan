...
<main id="primary" class="site-main">
	...
	<header class="news-header">
		<div class="container">
			...
			<p>Stay updated with the latest news, press releases, and announcements from IHC.</p>
		</div>
	</header>
					...
					while ( have_posts() ) :
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('news-card'); ?>>
							<a href="<?php the_permalink(); ?>">
								...
								<?php else : ?>
									<!-- Fallback image -->
									<img src="https://pub-a30c952d0179457fbf8fc3c73b51d5cf.r2.dev/image/57b141c9-23da-4347-80ce-526b85cf4e5c" alt="<?php the_title_attribute(); ?>" class="news-card-img">
								<?php endif; ?>
							</a>
